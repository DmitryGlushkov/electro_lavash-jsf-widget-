...
public class BlurHandler2 extends TagHandlerImpl implements BehaviorHolderAttachedObjectHandler {
    ...
    public BlurHandler2(TagConfig config) {
        super(config);
    ...
    private void applyNested(FaceletContext ctx, UIComponent parent, String eventName) {
        ...
        parent.getPassThroughAttributes(true).put("blurid", UUID.randomUUID().toString());
